...
<html>
    ...
    <body>
        ...
        <section>
            <article>
                <form method='POST' action='registrarCancha.jsp'>
                    <div class='titulo'>
                        <div class='imagen'>
                    ...
                    <div id='cuerpo'>
                        <div class='cajaformulario'>
                            ...
                            <div class='formulariosection'>
                                <input class='registro' type='text' name='nombreCancha' placeholder='Nombre cancha' required>
                            </div>
                            <div class='formulariosection'>
                                <input class='registro' type='text' name='direccionCancha' placeholder='Dirección cancha' required>
                            </div>
                        </div>
                    </div>
                    <div class='pie'>
