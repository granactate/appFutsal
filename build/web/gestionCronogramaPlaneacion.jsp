    ...
    <body>
        <header>
            <div id='cabecera'>
                ...
                <div id='infousuario'>
                    <%
                        out.print("Hello, " + usuario + " | <a href='jsp/cerrarSesion.jsp'/>Log out</a>");
                    %>
                </div>
            </div>
            <nav>
            ...
            <article>
                <form method='POST' action='asignarCanchasTorneo.jsp'>
                    <div class='titulo'>
                        ...
                        <div class='texto'>
                            Gestionar cronograma de planeación a un torneo
                        </div>
                    </div>
                    <div id='cuerpo'>
                        <div class='cajaformulario'>
                            <div class='formulariosection'>
                                <select name="torneo" id="torneo" autofocus>
                                    <%
                                        ArrayList<String> torneos = Facade.listarTorneosSinCronograma(usuario);
                            ...
                            <div class='formulariosection'>
                                <input type='text' class='registro' name='fechaLimiteInscripcion' placeholder='Fecha límite de inscripción' requered>
                                <input type='text' class='registro' name='fechaSorteoGrupos' placeholder='Fecha para el sorteo de los grupos' requered>
                                <input type='text' class='registro' name='fechaSorteoPartidos' placeholder='Fecha para el sorteo de los partidos' requered>
                                <input type='text' class='registro' name='FechaInicioTorneo' placeholder='Fecha inicio del torneo' requered>
                            </div>
                        </div>
                    </div>
                    <div class='pie'>
